...
您可以使用 Gitpod 作为一个在线 IDE(对于开放源码是免费的)来在线贡献或运行示例。
...
axios 很大程度上受到了[AngularJS](https://angularjs.org/)中提供的[$http 服务](https://docs.angularjs.org/api/ng/service/$http)的启发。
最终，axios 致力于提供一个独立的、类似于“$http”的服务，以便在 AngularJS 之外使用。
